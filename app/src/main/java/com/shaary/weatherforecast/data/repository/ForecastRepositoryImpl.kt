...
import com.shaary.weatherforecast.data.db.CurrentWeatherDao
import com.shaary.weatherforecast.data.db.FutureWeatherDao
import com.shaary.weatherforecast.data.db.WeatherLocationDao
...
import com.shaary.weatherforecast.data.network.FORECAST_DAYS
import com.shaary.weatherforecast.data.network.WeatherNetworkDataSource
...
class ForecastRepositoryImpl(
    ...
    private fun persistFetchedFutureWeather(fetchedWeather: FutureWeatherResponse) {
        ...
        // Deletes old data when fetching new
        GlobalScope.launch(Dispatchers.IO) {
    ...
    private suspend fun initWeatherData() {
        ...
        Log.d("weather location ", "$lastWeatherLocation")
