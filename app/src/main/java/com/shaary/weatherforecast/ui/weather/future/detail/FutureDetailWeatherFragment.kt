...
import com.shaary.weatherforecast.data.db.LocalDateConverter
import com.shaary.weatherforecast.internal.DateNotFoundException
...
class FutureDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        // Gets arguments from navigation
